...
public class InterfaceGUI4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel33.setBounds(420, 50, 160, 13);

        jLabel34.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel34.setText("pasien");
        getContentPane().add(jLabel34);
        jLabel34.setBounds(630, 50, 70, 13);
        ...
        queue_capacity.setBounds(580, 50, 39, 20);
        ...
        jLabel4.setBounds(420, 90, 110, 20);
        ...
        jLabel5.setBounds(420, 140, 80, 13);

        file_name.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        getContentPane().add(file_name);
        file_name.setBounds(520, 130, 350, 30);
        getContentPane().add(jSeparator1);
        jSeparator1.setBounds(420, 130, 460, 10);
        getContentPane().add(jSeparator2);
        jSeparator2.setBounds(420, 160, 460, 10);
        ...
        jLabel6.setText("Service Rate Poliklinik : ");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(750, 50, 140, 20);

        ser_rate_poli2.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        getContentPane().add(ser_rate_poli2);
        ser_rate_poli2.setBounds(890, 50, 30, 20);
    ...
    private void playActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playActionPerformed
        ...
        if(counter==0){
            ...
            if(file_name.getText().equals("")||file_name.getText().equals(null)){
            ...
            else if(ser_rate_poli2.getText().equals("")||ser_rate_poli2.equals(null)){
                JOptionPane.showMessageDialog(this,"Anda belum mengisi service rate poliklinik!","Alert",JOptionPane.ERROR_MESSAGE);
                ...
                kapasitasantrian=(int)queue_capacity.getValue();
                this.excel.createFile();
                this.excel.readExcel();
                double service_rate_poli=Double.parseDouble(ser_rate_poli2.getText());
                gen=new StatisticsGenerator(service_rate_poli);
                gen.setExcel(excel);
                for(int i=0;i<arrayServer.length;i++){
                        arrayServer[i]=new ServerAwal(i+1,gen,this);

                }
                sim=new StatisticsSimulationAwal(this.excel,arrayServer,gen,this,kapasitasantrian);
                for(int i=0;i<arrayDokter.length;i++){
...
//          grid.add(scatterChart,0,0);
  ...
  public void setChartPoli(int bpjsb,int bpjsl,int emr){
    ...
    private javax.swing.JTextField ser_rate_poli2;
